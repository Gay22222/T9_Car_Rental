...
public class ScheduleSelect extends AppCompatActivity {
    ...
    private EditText edtNgayNhan, edtGioNhan, edtNgayTra, edtGioTra;
    private Button btnRequestBooking;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtNgayNhan = findViewById(R.id.edt_NgayNhan);
        edtGioNhan = findViewById(R.id.edt_GioNhan);
        edtNgayTra = findViewById(R.id.edt_NgayTra);
        edtGioTra = findViewById(R.id.edt_GioTra);
        btnRequestBooking = findViewById(R.id.btn_requestbooking);

        btnRequestBooking.setOnClickListener(v -> {
            // FAKE DATA CHUYỂN MÀN
            String pickupDate = edtNgayNhan.getText().toString();
            String returnDate = edtNgayTra.getText().toString();
