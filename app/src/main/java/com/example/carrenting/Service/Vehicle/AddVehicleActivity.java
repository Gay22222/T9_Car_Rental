...
//                            vehicle.setOwner_id(document.get("user_id").toString());
//                            vehicle.setOwner_name(document.get("username").toString());
//                            vehicle.setOwner_address(document.get("address").toString() + " " + document.get("city").toString());
//                            vehicle.setOwner_email(document.get("email").toString());
//                            vehicle.setOwner_phone(document.get("phoneNumber").toString());
//
...
public class AddVehicleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(v -> {
            if (isValid()) {
                Toast.makeText(this, "Đã thêm xe (fake)", Toast.LENGTH_SHORT).show();
    ...
    private boolean isValid() {
        return !vehicle_name.getText().toString().trim().isEmpty() &&
                !vehicle_seats.getText().toString().trim().isEmpty() &&
                !vehicle_price.getText().toString().trim().isEmpty() &&
                !vehicle_owner.getText().toString().trim().isEmpty() &&
                !vehicle_number.getText().toString().trim().isEmpty();
    }
}
